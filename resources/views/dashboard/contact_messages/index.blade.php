                        ...
                        <tbody>
                            @foreach ($records as $record)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ isset(\App\Enums\GeneralEnums::ContactMessageStatuses[app()->getLocale()][$record->status]) ? \App\Enums\GeneralEnums::ContactMessageStatuses[app()->getLocale()][$record->status] : '' }}
                                    </td>
                                    <td class="text-center">
                                        {{ $record->project ? $record->project->{'name_' . app()->getLocale()} : '' }}
                                    </td>
                                        ...
                                        @if (canPass($path . '_destroy'))
                                            <a class="btn btn-danger btn-sm text-white"
                                                ...
                                                <form id="{{ 'deleteForm-' . $record->id }}"
                                                    action="{{ route('admin.' . $path . '.destroy', $record->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
