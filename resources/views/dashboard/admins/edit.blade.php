    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="{{ 'card card-' . PRIMARY_COLOR }}">
                ...
                <form role="form" method="POST" action="{{ route('admin.admins.update', $record->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputFullName" name="full_name"
                                ...
                                placeholder="{{ trans('cruds.' . $path . '.full_name') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail" name="email"
                                ...
                                placeholder="{{ trans('cruds.' . $path . '.email') }}">
                            @if ($errors->has('email'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputCountryCode" name="country_code"
                                value="{{ old('country_code', $record->country_code) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputMobile" name="mobile"
                                ...
                                placeholder="{{ trans('cruds.' . $path . '.mobile') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="exampleInputLocale" name="locale">
                                <option value="" disabled>
                                    {{ __('global.please_select', ['col' => trans('cruds.' . $path . '.locale')]) }}
                                </option>
                                @foreach (LOCALS as $locale)
                                    <option value="{{ $locale }}"
                                        {{ old('locale', $record->locale) == $locale ? 'selected' : '' }}>
                                        {{ $locale }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select class="form-control" id="exampleInputRole" name="role_id">
                                ...
                                @foreach ($roles as $role)
                                    <option value="{{ $role->id }}"
                                        {{ old('role_id', $record->role_id) == $role->id ? 'selected' : '' }}>
                                        {{ $role->$title }}
                                    </option>
                                @endforeach
                            </select>
