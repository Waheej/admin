...
class MakeCreateViewCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:crud-create-view {model}';
     ...
     * @var string
     */
    protected $description = 'Make Model create View';
    ...
    {
        return __DIR__ . '/../../../stubs/admin.create.view.stub';
    }
    ...
    public function getSourceFilePath()
    {
        ...
        return base_path('resources/views/dashboard/') . $path . '/create.blade.php';
    }
        ...
        foreach ($modelFillable as $col) {
            ...
            $column =   "<div class=\"form-group\">
                            ...
                            <input type=\"text\" class=\"form-control\" id=\"exampleInput" . Str::studly($col) . "\" name=\"{{ " . '"' . $col . '"'  . " }}\"
                                value=\"{{ old(" . '"' . $col . '"'  . ") }}\" placeholder=\"{{ trans('cruds.' . \$path . '.' . " . '"' . $col . '"' . ") }}\">
                            @if (\$errors->has(" . '"' . $col . '"'  . "))
