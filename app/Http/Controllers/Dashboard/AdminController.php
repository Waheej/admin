...
use App\Http\Requests\Dashboard\Create\CreateAdminRequest as CreateRequest;
use App\Http\Requests\Dashboard\Update\UpdateAdminRequest as UpdateRequest;
...
class AdminController extends Controller
{
    ...
    public function create()
    {
        ...
        try {
            $roles = Role::all();
            $path = Model::FILE_UPLOAD_PATH;
            return view('dashboard.' . $this->path . '.create', compact('roles', 'path'));
        } catch (\Throwable $th) {
            Log::error($th);
            abort(500);
        }
    ...
    public function store(CreateRequest $request)
    {
        ...
        try {
            ...
            if ($request->has('role_id')) {
                $role = Role::with('permissions')->findOrFail($request->input('role_id'));
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            $roles = Role::all();
            return view('dashboard.' . $this->path . '.edit', compact('record', 'path', 'roles'));
        } catch (\Throwable $th) {
            Log::error($th);
            abort(500);
        }
    ...
    public function permissions($id)
    {
        ...
        try {
            ...
            $userPermissions = Model::findOrFail($id)->permissions->pluck('permission')->toArray();
            ...
            return view('dashboard.' . $this->path . '.permissions', compact('records', 'path', 'user'));
        } catch (\Throwable $th) {
            Log::error($th);
            abort(500);
        }
