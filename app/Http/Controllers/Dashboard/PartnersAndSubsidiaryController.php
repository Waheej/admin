...
use App\Models\PartnerAndSubsidiaries as Model;
use App\Http\Requests\Dashboard\Create\CreatePartnerAndSubsidiariesRequest as CreateRequest;
use App\Http\Requests\Dashboard\Update\UpdatePartnerAndSubsidiariesRequest as UpdateRequest;
...
class PartnersAndSubsidiaryController extends Controller
{
    ...
    public function store(CreateRequest $request)
    {
        ...
        try {
            ...
            if ($request->has('img') && $request->img  != null) {
                $fileName = uploadMedia($request->img, $this->path);
